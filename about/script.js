document.addEventListener("DOMContentLoaded", () => {
  const memberData = {
    박준형: {
      ...
      job: "기획 / 디자인 / 개발",
      intro:
        "저는 인공지능 관련 분야에서 다양한 프로젝트를 진행하고, 다양한 알고리즘 문제들을 풀면서 문제 해결 능력과 기술적 역량을 키워왔습니다. 나아가 저는 인공지능이 아닌 다른 분야에도 다양한 관심을 가지며, Figma, HTML, CSS, JS 등을 공부하였습니다. 저는 이번 디미톤을 통해 협업 능력을 기르고 디자인, 웹에 관해 더 공부하며, 제 역량을 확장하고 싶습니다. 또한 이번 디미톤을 통해 아직 실전경험이 부족한 저희 팀이 실전 경험을 쌓아 자기 만족용이 아닌, 실제로 사람들에게 긍정적 영향을 미칠 수 있는 프로그램을 만들 수 있는 프로그래머로 성장하고 싶습니다.",
    ...
    장현중: {
      ...
      job: "기획 / 개발",
      intro:
        "solvedac 다이아 5 티어이며, 알고리즘에 대한 관심이 많습니다.<br />한번도 개발 대회를 나가보지 않아서 이번에 한번 학교 내부 대회를 도전하면서 저의 코딩실력을 다각도로 향상시키고 싶습니다. 저희 팀은 아직 실전 경험이 부족하지만 팀간의 화합을 잘 이루고 성실한 태도를 보이는 팀원들로 구성되어 있습니다. 팀원들과의 영리한 협동을 통해 더 나은 개발자적 역량을 기를 것입니다. 저도 또한 알고리즘 분야에 국한되는 것이 아닌 HTML, CSS, JS등을 공부하여 꼭 사회에 나가 긍정적인 웹 사이트 등을 개설하고 싶습니다.",
